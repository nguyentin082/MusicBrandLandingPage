...
export function Footer() {
  ...
  return (
    <footer id="contact" className="bg-dark-umber text-off-white pt-32 pb-12 px-6 dark:bg-dark-umber dark:text-off-white">
        ...
        <div className="grid md:grid-cols-2 gap-20 mb-20">
          <div>
            ...
            <p className="text-off-white/50 leading-relaxed italic">
              Premium sound studio specializing in recording, mixing, and mastering for independent artists worldwide.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-off-white/70">
                <a href="#services" className="block hover:text-warm-gold transition">
                  {t('links.services')}
                </a>
                <a href="#portfolio" className="block hover:text-warm-gold transition">
                  {t('links.portfolio')}
                </a>
                <a href="#contact" className="block hover:text-warm-gold transition">
                  {t('links.contact')}
                </a>
              </div>
            </div>
