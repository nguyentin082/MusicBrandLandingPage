    ...
    return (
        <section className="py-16 sm:py-24 md:py-32 bg-dark-umber dark:bg-dark-umber text-off-white dark:text-off-white px-4 sm:px-6 overflow-hidden">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-off-white/50 mb-8 sm:mb-10 leading-relaxed italic text-sm sm:text-base max-w-2xl mx-auto">
                    {t('description')}
                </p>
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-warm-gold italic">
