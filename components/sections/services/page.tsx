...
import { ArrowUpRight, Mic2, Music, Layers, PenLine } from 'lucide-react';
...
export async function ServicesSection() {
    ...
    const services = [
        ...
        },
        {
            icon: PenLine,
            key: 'sheetMusic',
            title: t('sheetMusic.title'),
            description: t('sheetMusic.description'),
        },
    ];
