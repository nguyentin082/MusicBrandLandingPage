    ...
    return (
        <section className="py-16 sm:py-24 md:py-32 bg-warm-gold dark:bg-warm-gold px-4 sm:px-6 relative overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto text-center relative z-10">
                <p className="text-dark-umber text-xs font-black uppercase tracking-[0.4em] mb-4 sm:mb-6 italic">
                    {t('label')}
                </p>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-dark-umber mb-6 sm:mb-8 italic tracking-tight">
                    {t('heading')}
                </h2>
